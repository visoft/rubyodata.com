...
With first-class support for GitHub Pages and Netlify, rubyodata.com has everything you need to get started building your website, including:
...
With rubyodata.com you can build your website with the tools you know and love, and deploy it to the platform of your choice with ease.

Read more at [https://getrubyodata.com.com](https://getrubyodata.com.com)!

## Get started: Use This Template

Get started with rubyodata.com one of the following ways:

✨ rubyodata.com will automatically remove its own branding and replace it with your own project name and description. See details [here](https://github.com/visoft/rubyodata.com/blob/main/.github/workflows/rubyodata.com-template.yml).
...
Start your project with rubyodata.com by clicking the "Use this template" button below:

<a href="https://github.com/visoft/rubyodata.com/generate">
...
Create a copy of rubyodata.com and deploy it straight to [Netlify](https://netlify.com) for **free**!
...
Get started from your command line
 ...
 ```sh
  gh repo create example.com --template visoft/rubyodata.com
 ```
